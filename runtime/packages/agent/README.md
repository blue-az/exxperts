# @exxeta/exxperts-core

Stateful agent with tool execution and event streaming. Built on `@exxeta/exxperts-ai`.

## Installation

```bash
npm install @exxeta/exxperts-core
```
...
```typescript
import { Agent, streamProxy } from "@exxeta/exxperts-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@exxeta/exxperts-core";
