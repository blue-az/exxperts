...
import type { ImageContent, Model } from "@exxeta/exxperts-ai";
...
export class ExtensionRunner {
	...
	private getContextPolicyFn: () => import("../context-policy.js").ContextPolicy | undefined = () => undefined;
	...
	bindCore(
		...
		this.getContextPolicyFn = contextActions.getContextPolicy;
	...
	createContext(): ExtensionContext {
		...
		return {
			...
			get contextPolicy() {
				runner.assertActive();
				return runner.getContextPolicyFn();
			},
		};
	}
	...
	async emitBeforeAgentStart(
		...
		contextPolicy?: import("../context-policy.js").ContextPolicy,
