...
import { type ImageContent, modelsAreEqual } from "@exxeta/exxperts-ai";
import { ProcessTerminal, setKeybindings, TUI } from "@exxeta/exxperts-tui";
...
import { handleSetupCommand } from "./cli/setup-openai-compatible.js";
...
function buildSessionOptions(
	...
	if (parsed.rawSystemPrompt) {
		options.rawSystemPrompt = parsed.rawSystemPrompt;
	}
...
export async function main(args: string[], options?: MainOptions) {
	...
	const createRuntime: CreateAgentSessionRuntimeFactory = async ({
		...
		const created = await createAgentSessionFromServices({
			...
			rawSystemPrompt: sessionOptions.rawSystemPrompt,
		});
