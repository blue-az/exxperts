...
/**
 * Migrate sessions from ~/.exxperts/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.exxperts/agent/ instead of
 * ~/.exxperts/agent/sessions/<encoded-cwd>/. This migration moves them
