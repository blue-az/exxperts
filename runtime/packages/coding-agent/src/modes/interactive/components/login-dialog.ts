import { getOAuthProviders } from "@exxeta/exxperts-ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@exxeta/exxperts-tui";
...
export class LoginDialogComponent extends Container implements Focusable {
	...
	showAuth(url: string, instructions?: string): void {
		...
		// Try to open browser. cmd's `start` treats the first quoted argument as
		// the window title, so it needs an empty title before the URL.
		const openCommand =
