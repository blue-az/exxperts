...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@exxeta/exxperts-ai`, `@exxeta/exxperts-core`, `@exxeta/exxperts-runtime`, `@exxeta/exxperts-tui`, `typebox`.
