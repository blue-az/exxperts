...
| Package | Purpose |
|---------|---------|
| `@exxeta/exxperts-runtime` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@exxeta/exxperts-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@exxeta/exxperts-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@exxeta/exxperts-runtime";
...
```typescript
import { isBashToolResult } from "@exxeta/exxperts-runtime";
...
```typescript
import { createLocalBashOperations } from "@exxeta/exxperts-runtime";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@exxeta/exxperts-ai";
...
```typescript
import type { AutocompleteItem } from "@exxeta/exxperts-tui";
...
```typescript
import { withFileMutationQueue } from "@exxeta/exxperts-runtime";
...
**Important:** Use `StringEnum` from `@exxeta/exxperts-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@exxeta/exxperts-runtime";
...
```typescript
import { createBashTool } from "@exxeta/exxperts-runtime";
...
```typescript
import { keyHint } from "@exxeta/exxperts-runtime";
...
```typescript
import { Text, Component } from "@exxeta/exxperts-tui";
...
import { matchesKey } from "@exxeta/exxperts-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@exxeta/exxperts-runtime";
