...
import { Container, type Terminal, Text, TUI } from "@exxeta/exxperts-tui";
...
// The diff renderer inserts intra-line highlight escapes (via chalk) depending on
// the environment's color support; strip them so substring assertions are stable.
