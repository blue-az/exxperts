...
import { setKeybindings } from "@exxeta/exxperts-tui";
...
describe("session selector path/delete interactions", () => {
	...
	it.skipIf(!symlinksSupported)("threads sessions when parent and child paths use different symlink aliases", async () => {
