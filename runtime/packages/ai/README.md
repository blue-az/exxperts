...
```bash
npm install @exxeta/exxperts-ai
```

TypeBox exports are re-exported from `@exxeta/exxperts-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@exxeta/exxperts-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@exxeta/exxperts-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@exxeta/exxperts-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@exxeta/exxperts-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@exxeta/exxperts-ai';
...
```typescript
import { getModel, stream } from '@exxeta/exxperts-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@exxeta/exxperts-ai';
...
```typescript
import { Model, stream } from '@exxeta/exxperts-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@exxeta/exxperts-ai';
...
```typescript
import { getModel, complete, Context } from '@exxeta/exxperts-ai';
...
```typescript
import { Context, getModel, complete } from '@exxeta/exxperts-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@exxeta/exxperts-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@exxeta/exxperts-ai';
...
```bash
npx @exxeta/exxperts-ai login              # interactive provider selection
npx @exxeta/exxperts-ai login anthropic    # login to specific provider
npx @exxeta/exxperts-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@exxeta/exxperts-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@exxeta/exxperts-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@exxeta/exxperts-ai/oauth';
...
```typescript
import { getModel, complete } from '@exxeta/exxperts-ai';
import { getOAuthApiKey } from '@exxeta/exxperts-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@exxeta/exxperts-ai`
