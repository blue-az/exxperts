...
describe("openai-completions cacheControlFormat", () => {
	...
	it("sets Anthropic-style ttl when split TTL support is enabled", async () => {
		const model: Model<"openai-completions"> = {
			id: "custom-anthropic",
	...
	it("omits Anthropic-style ttl when split TTL support is disabled", async () => {
		const model: Model<"openai-completions"> = {
			id: "custom-anthropic",
			name: "Custom Anthropic",
			api: "openai-completions",
			...
			compat: {
				cacheControlFormat: "anthropic",
				supportsAnthropicCacheControlTtl: false,
			},
		};
