# @exxeta/exxperts-web-ui

Reusable web UI components for building AI chat interfaces powered by [@exxeta/exxperts-ai](../ai) and [@exxeta/exxperts-core](../agent).
...
```bash
npm install @exxeta/exxperts-web-ui @exxeta/exxperts-core @exxeta/exxperts-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@exxeta/exxperts-web-ui';
import '@exxeta/exxperts-web-ui/app.css';
...
declare module '@exxeta/exxperts-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@exxeta/exxperts-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@exxeta/exxperts-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@exxeta/exxperts-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@exxeta/exxperts-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@exxeta/exxperts-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@exxeta/exxperts-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@exxeta/exxperts-web-ui';
...
```typescript
import { SessionListDialog } from '@exxeta/exxperts-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@exxeta/exxperts-web-ui';
...
```typescript
import { ModelSelector } from '@exxeta/exxperts-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@exxeta/exxperts-web-ui';
